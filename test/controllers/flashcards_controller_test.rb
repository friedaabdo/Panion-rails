...
class FlashcardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flashcard" do
    assert_difference('Flashcard.count') do
      post flashcards_url, params: { flashcard: { original: @flashcard.original, translated: @flashcard.translated } }, as: :json
    end
  ...
  test "should update flashcard" do
    patch flashcard_url(@flashcard), params: { flashcard: { original: @flashcard.original, translated: @flashcard.translated } }, as: :json
    assert_response 200
  end
